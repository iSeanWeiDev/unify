...
class TaskModal extends Component
{
  ...
  handleSubmit() {
    ...
    if (this.state.isEditing) {
      ...
      this.props.updateUserStory(payload);
    } else {
      this.props.createNewUserStory(payload);
    }
...
const mapDispatchToProps = dispatch => ({
  createNewUserStory: payload => dispatch(UserStoryActions.createNewUserStoryRequest(payload)),
  updateUserStory: payload => dispatch(UserStoryActions.updateUserStoryRequest(payload))
});
